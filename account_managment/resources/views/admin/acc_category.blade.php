...
<div class="row">
                ...
                <table id="mainHeadTable" class="table table-accounts table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('acc_category_edit', $category->id) }}"
    ...
    <div class="col-md-4">
        <div class="panel panel-default panel_s">
            <div class="panel-body">
                <h4 class="no-margin">Accounts Category</h4>
                <hr class="hr-panel-heading" />
                <form action="{{ isset($edit_type) ? route('acc_category_update', $edit_type->id) : route('acc_category_store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="short_name" name="short_name" class="form-control"
                            autocomplete="off" value="{{ old('short_name', $edit_type->short_name ?? '') }}">
                    </div>

                    <div class="form-group">
                        <label for="long_name" class="control-label">Long Name</label>
                        <input type="text" id="long_name" name="long_name" class="form-control"
                            autocomplete="off" value="{{ old('long_name', $edit_type->long_name ?? '') }}">
                    </div>

                    <button class="btn btn-info" type="submit">
                        {{ isset($edit_type) ? 'Update' : 'Submit' }}
                    </button>

                    @if(isset($edit_type))
                    <a href="{{ route('acc_category') }}" class="btn btn-success text-white">Back</a>
                    @endif
                </form>
            </div>
        </div>
