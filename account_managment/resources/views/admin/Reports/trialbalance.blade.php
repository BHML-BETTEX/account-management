...
<div class="panel_s">
    <div class="panel-body">
        <h4 class="no-margin font-bold">Trial Balance</h4>
        <hr />
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <form action="https://democrm.i2technologies.net/admin/accounting/view_report" id="filter-form" method="post" accept-charset="utf-8">
                        ...
                        <div class="col-md-3">
                            <div class="form-group" app-field-wrapper="from_date"><label for="from_date" class="control-label">Trail Balance Date</label>
